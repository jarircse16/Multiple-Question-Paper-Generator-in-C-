...
int main() {
    ...
    cout << "How many questions do you need in each question paper?" << endl;
    int num_questions;
    cin >> num_questions;

    // Choose the number of question papers to generate
    cout << "How many question papers do you want to generate?" << endl;
    int num_papers;
    cin >> num_papers;
    ...
    for (int i = 1; i <= num_papers; i++) {
        ...
        for (int j = 0; j < num_questions; j++) {
            ...
            string curr_question = "Question " + to_string(j + 1) + ": " + questions[index] + "\n";
